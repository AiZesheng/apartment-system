<template>
  <div class="s-index">
    <div class="main-title clearfix">
      <div><span class="click" @click="toRooms">房间信息管理</span> > 房间信息</div>
      <div class="main">
        ...
        <el-form ref="mes" :model="mes" label-width="100px" class="form">
          <el-form-item label="宿舍楼" prop="apartment" :rules="{
            ...
            <el-select disabled v-model="mes.apartment" placeholder="请选择">
          ...
          <el-form-item label="房间号" prop="roomNo" :rules="{
            ...
            <el-input disabled v-model="mes.roomNo" placeholder="请输入房间号" style="width: 600px;"></el-input>
          </el-form-item>
          <el-form-item label="房间类型" prop="roomType" :rules="{
            required: true, message: '请选择房间类型', trigger: 'change'
          }">
            <el-select disabled v-model="mes.roomType" placeholder="请选择">
          ...
          <el-form-item label="房间成员">
            <span class="mr-20" v-for="x in nameArr">{{x}}</span>
          </el-form-item>
          <el-form-item label="">
            <!-- <el-button type="primary" @click="submitForm('mes')">确 定</el-button> -->
            <el-button type="primary" @click="toRooms">返 回</el-button>
          </el-form-item>
        </el-form>
      </div>
    </div>
...
<script>
  export default {
    ...
    created () {
      ...
      this.nameArr = this.$route.query.name;
